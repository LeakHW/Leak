...
//                                         //
//    tool-config.js • Sparx Science       //
//       Science Tool Configuration        //
/////////////////////////////////////////////

(function() {
    /**
     * SPARX SCIENCE TOOL CONFIGURATION
    ...
    window.LeakConfig = {
        ...
        injection: {
            selector: '[role="menu"], .chakra-menu__menu-list',
            targetText: 'Sign out',
            separatorSelector: 'hr, .chakra-menu__divider',
            label: 'Leak',
            iconHtml: `
